      ...
      return $uploadForm.find("input[type='file']").fileupload({
        ...
        progress: function(e, data) {
          ...
          if (callback_url) {
            ...
            if ($uploadForm.data('media-id')) {
              content['mediaId'] = $uploadForm.data('media-id');
            }
            $.ajax({
...
(function() {
  $(function() {
    ...
    return $('#s3-uploader').bind("s3_upload_complete", function(e, content) {
      ...
      return $('#media_last_modified').val(content.lastModifiedDate);
    });
  });
