    ...
    $uploadForm.find("input[type='file']").fileupload
      ...
      add: (e, data) ->
        ...
        unless settings.before_add and not settings.before_add(file)
          ...
          if $('#template-upload').length > 0
            ...
            #console.log("Adding file:"+JSON.stringify(settings))
      ...
      progress: (e, data) ->
        if data.context
          ...
          #console.log("Progress context:"+JSON.stringify(data.context))
        ...
        if callback_url
          ...
          #console.log("Done mediaId:"+$uploadForm.data('media-id'))
          content['mediaId'] = $uploadForm.data('media-id') if $uploadForm.data('media-id')
          $.ajax
